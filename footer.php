...
<footer class="pie-pagina">
  <div class="grupo-1">
      <div class="box">
          <figure>
              <a href="#">
                  <img src="./images/margaritas.png" alt="Logo de SLee Dw">
              </a>
          </figure>
      </div>
      <div class="box">
          <h2>SOBRE NOSOTROS</h2>
          <p>Finca las margaritas ofrece variedad de productos lacteos elaborados con la mejor calidad, también encontraras la mejor raza de animales para levante. </p>         
     <div class="red-social"> <a href="https://www.google.com.co/maps/place/Tesalia,+Huila/@2.545389,-75.6742121,12z/data=!3m1!4b1!4m5!3m4!1s0x8e3b27d1c2a7313b:0x76d94faf94d1ce90!8m2!3d2.5185532!4d-75.6906241?hl=es-419"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
  <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A31.493 31.493 0 0 1 8 14.58a31.481 31.481 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94zM8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10z"/>
  <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
</svg></a></div>
<p>Nos encontramos ubicados en la vereda la Hocha del municipio de Tesalia Huila</p>
      </div>
      <div class="box">
          <h2>CONTACTENOS</h2>
  ...
  <div class="grupo-2">
      <small>&copy; 2022 <b>Todos los Derechos Reservados</b></small>
  </div>
</footer>
